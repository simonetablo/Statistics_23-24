...
namespace WindowsFormsApp1
{
    internal class ResizableRectangle
    {
        ...
        public void drawChart(ObjectChart chart, bool rotation)
        {
            ...
            /*if (rotation)
            {
                c.Width = this.pictureBox.Width / 4 * 3;
                c.Height = this.pictureBox.Height;
            }
            else {*/ c.Size = this.pictureBox.Size; //}
        ...
        public void drawHistogram(ObjectHistogram histogram, bool rotation)
        {
